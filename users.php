...
<body class="red lighten-5">
  ...
  <header id="header" class="page-topbar">
        ...
        <div class="parallax"><img src="images/home.jpg"></div>
        </div>
        <!-- end header nav-->
  </header>
  <!-- END HEADER -->
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Manipulate user tables</p>
...
<table>
          ...
          echo '<td><div class="input-field col s12"><label for="'.$row["id"].'_username">Username</label>';
					echo '<input value="'.$row["username"].'" id="'.$row["id"].'_username" name="'.$row['id'].'_username" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';
          
          echo '<td><div class="input-field col s12"><label for="'.$row["id"].'_password">Password</label>';
					echo '<input value="'.$row["password"].'" id="'.$row["id"].'_password" name="'.$row['id'].'_password" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';
					echo '<td><div class="input-field col s12"><label for="'.$row["id"].'_email">E-mail</label>';
					...
					echo '<td><div class="input-field col s12"><label for="'.$row["id"].'_contact">Contact</label>';
					...
					echo '<td><div class="input-field col s12"><label for="'.$row["id"].'_address">Address</label>';
					echo '<input value="'.$row["address"].'" id="'.$row["id"].'_address" name="'.$row['id'].'_address" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';    					
...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Copyright © 22/12/2019 <a class="grey-text text-lighten-4" href="#" target="_blank">Group ASS 7</a> All rights not reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Group ASS 7</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
