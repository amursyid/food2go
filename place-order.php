...
<body class="purple lighten-5">
  ...
  <header id="header" class="page-topbar">
        ...
        <div class="parallax"><img src="images/headerimg3.jpg"></div>
        </div>
        <!-- end header nav-->
  </header>
  <!-- END HEADER -->
...
<div>
                <div class="card-panel">
                  ...
                  <option value="Wallet" selected>Card</option>							
							</select>
                        </div>
                      </div>					
                      <div class="row">
...
?>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 22/12/2019 <a class="grey-text text-lighten-4" href="#" target="_blank">GROUP ASS 7</a> All rights reserved.</span>
