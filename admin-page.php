    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" enctype="multipart/form-data">
            <div class="row">
          ...
          echo '<td><img src="images/'.$row["imageLoc"].'" style="float:left;width:50px;height:50px;">';
        
          //echo '<input value="'.$row["imageLoc"].'" id="'.$row["id"].'_imageLoc" name="'.$row['id'].'_imageLoc" type="file" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></<div>';
          					
          echo '<td><div class="input-field col s12"><label for="'.$row["id"].'_description">Description</label>';
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Image Location</th>
          ...
          echo '<input id="name" name="name" type="text" data-error=".errorTxt01"><div class="errorTxt01"></div></td>';
					//echo '<td><input id="imageLoc" name="imageLoc" type="file" data-error=".errorTxt01"><div class="errorTxt01"></div>';					
          echo '<td><div class="file-field input-field">
                  <div class="btn">
                    <span>File</span>
                        <input id="imageLoc" name="imageLoc" type="file" data-error=".errorTxt01">
                      </div>
                    <div class="file-path-wrapper">
                    <input class="file-path validate" type="text">
                    </div>
                </div></td>';
          echo '<td><div class="input-field col s12 "><label for="description" class="">Description</label>';
          echo '<input id="description" name="description" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';
