...
<body class="purple lighten-5">
  ...
  <header id="header" class="page-topbar ">
        ...
        <div class="parallax"><img src="images/headerimg1.jpg"></div>
        </div>
        <!-- end header nav-->
  </header>
  <!-- END HEADER -->
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
        <h5 class="breadcrumbs-title">PLEASE EDIT YOUR PERSONNEL DETAILS</h5>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>
				...
				{
          echo '<tr><td>'.$row["name"].'</td><td><img src="images/'.$row["imageLoc"].'" style="float:left;width:50px;height:50px;"></td><td>'.$row["description"].'</td><td>'.$row["price"].'</td>';                    
					echo '<td><div class="input-field col s12"><label for='.$row["id"].' class="">Quantity</label>';
					echo '<input value = "0" id="'.$row["id"].'" name="'.$row['id'].'" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td></tr>';
				}
				?>
                    </tbody>
</table>
